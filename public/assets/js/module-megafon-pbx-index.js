 ...
 *
 */
var idUrl = 'module-megafon-pbx';
var idForm = 'module-megafon-pbx-form';
var className = 'ModuleMegafonPbx';
var inputClassName = 'mikopbx-module-input';

/* global globalRootUrl, globalTranslate, Form, Config */
var ModuleMegafonPbx = {
  $formObj: $('#' + idForm),
  ...
  cbBeforeSendForm: function cbBeforeSendForm(settings) {
    ...
    window[className].$checkBoxes.each(function (index, obj) {
      var name = $(obj).find('input[type="checkbox"]').attr('name');
  ...
  changeStatus: function changeStatus(status) {
    switch (status) {
      case 'Connected':
        ...
        window[className].$moduleStatus.html(globalTranslate.module_megafon_pbxConnected);
        break;
      case 'Disconnected':
        window[className].$moduleStatus.removeClass('green').removeClass('red').addClass('grey');
        window[className].$moduleStatus.html(globalTranslate.module_megafon_pbxDisconnected);
        break;
      case 'Updating':
        window[className].$moduleStatus.removeClass('green').removeClass('red').addClass('grey');
        window[className].$moduleStatus.html("<i class=\"spinner loading icon\"></i>".concat(globalTranslate.module_megafon_pbxUpdateStatus));
        break;
      default:
        window[className].$moduleStatus.removeClass('green').removeClass('red').addClass('grey');
        window[className].$moduleStatus.html(globalTranslate.module_megafon_pbxDisconnected);
...
//# sourceMappingURL=module-megafon-pbx-index.js.map