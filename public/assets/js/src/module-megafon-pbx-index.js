 ...
 *
 */
const idUrl     = 'module-megafon-pbx';
const idForm    = 'module-megafon-pbx-form';
const className = 'ModuleMegafonPbx';
const inputClassName = 'mikopbx-module-input';

/* global globalRootUrl, globalTranslate, Form, Config */
const ModuleMegafonPbx = {
	$formObj: $('#'+idForm),
		...
		switch (status) {
			...
			case 'Updating':
				window[className].$moduleStatus
					...
					.removeClass('red')
					.addClass('grey');
				window[className].$moduleStatus.html(`<i class="spinner loading icon"></i>${globalTranslate.module_megafon_pbxUpdateStatus}`);
				break;
			default:
				window[className].$moduleStatus
					.removeClass('green')
